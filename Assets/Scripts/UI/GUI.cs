    ...
    public class GUI : MonoBehaviour
    {
        ...
        public void SelectQuest(int id)
        {
            ...
            foreach (Actor adventurer in GameManager.Instance.Adventurers)
            {
                ...
                questAdventurer.GetComponent<RectTransform>()
                    .anchoredPosition = new Vector3(400 * (i % 3) / 3f,
                    -30 - 100 * (i / 3));
                i++;
            }
            _startQuestButton.interactable = false;
        ...
        /// <summary>
        /// Switches the panel at the bottom of the screen when switching <see cref="GameMode"/>.
        /// </summary>
