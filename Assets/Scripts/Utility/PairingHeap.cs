...
public class PairingHeap<T1, T2> where T2 : System.IComparable
{
    ...
    /// <summary>
    /// Melds the roots of two seperate heaps to create one heap.
    /// </summary>
    ...
    private class Node : IReference
    {
        ...
        /// </summary>
        /// <param name="element">The object being sorted into the <see cref="PairingHeap{T1, T2}{T1, T2}"/>.</param>
        /// <param name="priority">The priority of <c>element</c>.</param>
        ...
        /// <value>The value of type <see cref="T2"/> determining the <see cref="Node"/>'s priority within the <see cref="PairingHeap{T1, T2}{T1, T2}"/>.</value>
