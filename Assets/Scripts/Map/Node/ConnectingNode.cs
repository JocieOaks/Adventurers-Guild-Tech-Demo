...
public abstract class ConnectingNode : IDividerNode
{
    ...
    public ConnectingNode(RoomNode connection1, RoomNode connection2, Vector3Int worldPosition)
    {
        FirstNode = connection1;
        SecondNode = connection2;

        if(connection1.WorldPosition.x == connection2.WorldPosition.x)
        {
            Alignment = MapAlignment.XEdge;
        }
        else
        {
            Alignment= MapAlignment.YEdge;
        }
    ...
    /// <value>Returns true if both <see cref="RoomNode"/>'s bordering the <see cref="ConnectingNode"/> are within the same <see cref="global::Room"/>.</value>
    ...
    /// <inheritdoc/>
    public virtual RoomNode SecondNode { get; }
    ...
    /// </summary>
    /// <param name="connection">The <see cref="ConnectingNode"/> that share's an adjacent <see cref="global::Room"/>.</param>
    ...
    /// <summary>
    /// Adds this <see cref="ConnectingNode"/> to the <see cref="global::Room.Connections"/> of it's adjacent <see cref="global::Room"/>s.
    /// </summary>
    ...
    /// <summary>
    /// Removes a <see cref="ConnectingNode"/> from the list of nodes that share and adjoining <see cref="global::Room"/> with this <see cref="ConnectingNode"/>.
    /// </summary>
