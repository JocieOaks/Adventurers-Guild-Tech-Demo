...
public readonly struct ActorAppearance
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ActorAppearance"/> struct, randomly initializing the appearance proprties based on the predetermined <see cref="Race"/>.
    /// </summary>
