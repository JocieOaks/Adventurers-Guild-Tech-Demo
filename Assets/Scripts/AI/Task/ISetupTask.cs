...
/// <summary>
/// The <see cref="ISetupTask"/> interface is for <see cref="Task"/>s that enabble another <see cref="Task"/> to be performed. This ensures that the <see cref="Payoff"/> <see cref="Task"/> is considered 
