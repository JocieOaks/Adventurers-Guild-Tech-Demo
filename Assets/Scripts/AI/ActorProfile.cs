...
namespace Assets.Scripts.AI
{
    ...
    {
        private float _hunger, _sleep, _social;
        ...
        public ActorProfile(Actor actor)
        {
            ...
            Abilities = new[] { actor.Strength, actor.Dexterity, actor.Charisma, actor.Intelligence };
        ...
        /// <value>The map position of the <see cref="AdventurerPawn"/> corresponding to the <see cref="Actor"/>.</value>
        public Vector3Int Position { get; set; }

        /// <value>The <see cref="Map.Node.RoomNode"/> the <see cref="AdventurerPawn"/> corresponding to the <see cref="Actor"/> is in.</value>
        public RoomNode RoomNode => Map.Map.Instance[Position];
        ...
        /// <value>The speed of the <see cref="Actor"/>'s corresponding <see cref="AdventurerPawn"/>.</value>
        public float Speed { get; }

        /// <value>The <see cref="Stance"/> of the <see cref="Actor"/>'s corresponding <see cref="AdventurerPawn"/>.</value>
