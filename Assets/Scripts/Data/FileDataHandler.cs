...
namespace Assets.Scripts.Data
{
    ...
    public class FileDataHandler
    {
        ...
        public List<string> LoadNames()
        {
            ...
            {
                Debug.LogError("Error occurred when trying to load data from file: quest_data" + "\n" + e);
            }
        ...
        public GameData LoadNew()
        {
            ...
            {
                Debug.LogError("Error occurred when trying to load data from file: start_save" + "\n" + e);
            }
